...
#   -> mz/data/Pokemon.json (consumível pelo RPG Maker MZ)
#
# Uso:  ruby mz/tools/compile_pbs.rb [caminho/pokemon.txt] [saida.json]
# Padrao: le "PBS/pokemon.txt", escreve "mz/data/Pokemon.json"
require "json"

src = ARGV[0] || "PBS/pokemon.txt"
out = ARGV[1] || "mz/data/Pokemon.json"
