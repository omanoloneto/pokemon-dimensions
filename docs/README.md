# Documentação de Design — Pokémon Dimensions

Fangame monster collector multi-franquia (RPG Maker MZ). Documentos na ordem de leitura:

| Doc | Conteúdo |
|---|---|
| [01-visao-geral.md](01-visao-geral.md) | Pitch, pilares, escopo, princípios de design |
| [02-franquias.md](02-franquias.md) | Identidade mecânica de cada franquia e tipos unificados |
| [03-mundo-e-narrativa.md](03-mundo-e-narrativa.md) | Estrutura do mundo, arco em 3 atos, progressão, templates de produção |
